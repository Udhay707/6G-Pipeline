...
-- Insert into DnnPolicyDecision table
INSERT INTO `DnnPolicyDecision` (`Dnn`, `DnnIsSet`, `PccRuleIdsIsSet`)
VALUES ('default', 1, 1);

-- Insert into DnnPolicyDecision_PccRuleIds table
INSERT INTO `DnnPolicyDecision_PccRuleIds` (`object_id`, `index`, `value`)
VALUES ('default', 0, 'internet-rule');
